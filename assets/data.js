...
export const questionsArray = [
    {
      ...
      explanation: "In JavaScript, you can declare variables using `var`, `let`, or `const`. Each has different scoping rules and usage."
    },
    {
      id: 2,
    ...
    },
    {
      ...
      explanation: "Due to a historical bug in JavaScript, the `typeof` operator returns 'object' for `null` instead of 'null'."
    },
    {
      id: 4,
    ...
    },
    {
      ...
      explanation: "`isNaN()` determines whether a value is NaN (Not-a-Number). If the value is NaN, it returns true."
    },
    {
      id: 7,
      ...
      correctAnswer: "22",
      explanation: "When adding a number and a string, JavaScript performs type coercion, converting the number to a string and concatenating them."
    },
    {
      id: 8,
      question: "Which JavaScript method is used to find the largest number in an array?",
      answers: [
        "Math.max()",
        "Math.min()",
        "Math.large()",
      ...
      explanation: "`Math.max()` takes arguments and returns the largest number. Use the spread operator to find the max in an array."
    },
    {
      id: 9,
      ...
      correctAnswer: "const",
      explanation: "`const` is used to declare constants, which are block-scoped and cannot be reassigned after initialization."
    },
    {
      id: 10,
    ...
    },
    {
      ...
      explanation: "Variables declared with `var` are hoisted to the top of their scope but remain uninitialized until their declaration is encountered."
    },
    {
      id: 12,
      ...
      correctAnswer: "24, because numbers starting with 0 are treated as octal literals",
      explanation: "In non-strict mode, numbers starting with `0` are interpreted as octal (base 8). `030` in octal equals 24 in decimal."
    }
  ];
